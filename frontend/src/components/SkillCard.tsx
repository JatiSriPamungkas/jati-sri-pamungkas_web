...
const SkillCard = ({ src, title, children }: { src: string; title: string; children: string }) => {
	return (
		<>
			<div className="relative flex flex-col items-center w-full h-75 shadow-[4px_4px_15px_3px_rgba(0,0,0,0.25)] rounded-[10px] bg-[#FFFBF3] pb-16 min-[1025px]:h-100">
				<img
					src={src}
					alt="Skill Logo"
					className="pt-14 w-[125px] min-[1025px]:w-[175px]"
				/>
