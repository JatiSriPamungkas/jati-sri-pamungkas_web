	...
	return (
		<>
			<div className="box-border flex flex-col justify-center items-center min-h-screen gap-6 font-lexend bg-stone-100">
				...
				<h2 className="text-3xl font-bold text-secondary">404 - Not Found Page</h2>
				<p>
				...
				<Link
					to="/"
					className="text-center border-2 w-1/5 py-3 rounded-lg bg-primary text-white bg-slate-700 transition-all hover:bg-slate-600"
				>
					Back to Home
				</Link>
			</div>
